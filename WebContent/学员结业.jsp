...
<body>
	<table border="0" width="100%">
		<tr>
			<td align="center" style="font-size: 24px; color: #666">学员结业</td>
		</tr>
		<tr>
			<td align="right"><a
				href="${pageContext.request.contextPath}/student_findAll.action">查询所有学员</a></td>
		</tr>
	</table>
		...
		<tbody>
			<s:iterator value="list" var="stu">
				<tr>
					...
					<td align="center"><a href="${pageContext.request.contextPath }/student_modifyStatusToGra.action?IDnumber=<s:property value="#stu.IDnumber"/>">结业</a></td>
				</tr>
			</s:iterator>
		</tbody>
	</table>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		<tr>
			<td align="right"><span>第<s:property value="currPage" />/<s:property
						value="totalPage" />页
			</span>&nbsp;&nbsp; <span>总记录数:<s:property value="totalCount" />条&nbsp;&nbsp;每页显示:<s:property
						value="pageSize" />条
			</span>&nbsp;&nbsp; <span> <s:if test="currPage != 1">
						<a
							href="${pageContext.request.contextPath }/student_findAll.action?currPage=1">[首页]</a>&nbsp;&nbsp;
						<a
							href="${pageContext.request.contextPath }/student_findAll.action?currPage=<s:property value="currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
					</s:if> <s:if test="currPage != totalPage">
						<a
							href="${pageContext.request.contextPath }/student_findAll.action?currPage=<s:property value="currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
						<a
							href="${pageContext.request.contextPath }/student_findAll.action?currPage=<s:property value="totalPage"/>">[尾页]</a>&nbsp;&nbsp;
					</s:if>
			</span></td>
		</tr>
	</table>

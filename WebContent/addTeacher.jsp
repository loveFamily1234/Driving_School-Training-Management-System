...
<body>
	<table border="0" width="100%">
		<tr>
			<td align="center" style="font-size: 24px; color: #666">添加教练信息</td>
		</tr>
		<tr>
	...
	<br/>
	<s:form action="teacher_save" method="post" namespace="/" theme="simple">
		<table align="center" class="table2">
			<tr>
				<td>教练ID：</td><td><s:textfield name="IDnumber" /></td>
			</tr>
			<tr>
				<td>手机号：</td><td><s:textfield name="phoneNum" /></td>
			</tr>
			<tr>
				<td>姓名：</td><td><s:textfield name="teacherName" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td>性别：</td>
				<td align="center"><s:radio name="gender" list="{'男','女'}"/></td>
			</tr>
			<tr>

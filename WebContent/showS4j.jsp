...
<body>
	<table border="0" width="100%">
		<tr>
			<td align="center" style="font-size: 24px; color: #666">科目四 ·判断题</td>
		</tr>
		<tr>
			<td align="right"><a
	...
	<table cellspacing="0" border="1" class="table1">
		<%
			List<Judgment> list = (List<Judgment>) ActionContext.getContext().getApplication().get("s4j");
		...
		<div>
			...
			<div>
					...
					<a style="margin-right:20px;" href="${pageContext.request.contextPath}/testJudgment_subject4Judgment.action?currPosition=<%=currPosition+1 %>">下一题</a>
					<a href="${pageContext.request.contextPath}/testJudgment_subject4Judgment.action?currPosition=<%=currPosition-1 %>">上一题</a>
			</div>

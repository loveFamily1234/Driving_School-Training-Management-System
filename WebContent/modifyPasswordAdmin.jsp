...
<body>
	...
	<br/>
	<s:form action="modifyPasswordOperator_updateAdmin" method="post" namespace="/" theme="simple">
<%-- 		<h3><s:actionerror/></h3> --%>
		<table align="center" class="table2">
		<%
			Administrator admin = (Administrator)ActionContext.getContext().getApplication().get("existPerson");

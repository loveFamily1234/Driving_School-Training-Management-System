...
<body>
	<table border="0" width="100%">
		<tr>
			<td align="center" style="font-size: 24px; color: #666">科目一 ·单选题</td>
		</tr>
		<tr>
			<td align="right"><a
				href="${pageContext.request.contextPath}/题库练习之科目一.jsp">退出练习</a></td>
		</tr>
	</table>
	...
	<table cellspacing="0" border="1" class="table1">
		<%
			List<Choice> list = (List<Choice>) ActionContext.getContext().getApplication().get("s1se");
		...
		<div>
			...
			<div>
					...
					<a style="margin-right:20px;" href="${pageContext.request.contextPath}/testChoice_subject1SingleElection.action?currPosition=<%=currPosition+1 %>">下一题</a>
					<a href="${pageContext.request.contextPath}/testChoice_subject1SingleElection.action?currPosition=<%=currPosition-1 %>">上一题</a>
			</div>

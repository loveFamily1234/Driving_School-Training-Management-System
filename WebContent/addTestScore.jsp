...
<body>
	<table border="0" width="100%">
		<tr>
			<td align="center" style="font-size: 24px; color: #666">添加考试成绩信息</td>
		</tr>
		<tr>
	...
	<br/>
	<s:form action="testScore_save" method="post" namespace="/" theme="simple">
		<table align="center" class="table2">
			...
			<tr>
				<td>考试成绩：</td>
				<td><s:textfield name="score" /></td>
			</tr>
			<tr>
				<td>取得该成绩时间：</td><td><input name="timeScore" type="date" /></td>
			</tr>
			<tr>

...
<body>
	...
	<br/>
	<s:form action="modifyPasswordOperator_updateB" method="post" namespace="/" theme="simple">
<%-- 		<h3><s:actionerror/></h3> --%>
		<table align="center" class="table2">
		<%
			Operator operator = (Operator)ActionContext.getContext().getApplication().get("existPerson");
			String phoneNum = operator.getPhoneNum();
		%>
			<tr>
